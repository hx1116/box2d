	...
	**/
	export class b2Math {
		...
		**/
        ...
        public static MulQV(q: b2Vec2, v: b2Vec2): b2Vec2;
		/**
	...
	**/
	export class b2DebugDraw {
		...
		**/
		...
		//后面自己加的center, size, color
   	    public DrawPoint(center: Box2D.Common.Math.b2Vec2, size: number, color: Box2D.Common.b2Color): void;
		/**
		* Draw a solid circle.
		* @param center Circle center point.
		* @param radius Circle radius.
		...
		**/
		public SetSprite(canvas: egret.Sprite): void;
	...
	**/
	export class b2JointDef {
		...
		**/
		...
		public target: Box2D.Common.Math.b2Vec2; //huangxiang
	...
	**/
	export class b2LineJoint extends b2Joint {
		...
		**/
		...
		public m_localXAxis1:Box2D.Common.Math.b2Vec2;
	}
}
